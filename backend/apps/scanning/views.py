...
class ScanSessionViewSet(viewsets.ModelViewSet):
    ...
    def start(self, request, pk=None):
        ...
        try:
            ...
            logger.error("Error starting scan session: %s", e)
            return Response(
                {'error': str(e)},
    ...
    def tools(self, request, pk=None):
        ...
        try:
            ...
            logger.error("Error getting scan tools: %s", e)
            return Response(
                {'error': str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
    ...
    def create_orchestrated_scan(self, request):
        ...
        try:
            ...
            logger.error("Error creating orchestrated scan: %s", e)
            return Response(
                {'error': str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
...
class ToolExecutionViewSet(viewsets.ReadOnlyModelViewSet):
    ...
    def output(self, request, pk=None):
        ...
        try:
            ...
            logger.error("Error getting tool output: %s", e)
            return Response(
                {'error': str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
    ...
    def retry(self, request, pk=None):
        ...
        try:
            ...
            logger.error("Error retrying tool execution: %s", e)
            return Response(
                {'error': str(e)},
                status=status.HTTP_500_INTERNAL_SERVER_ERROR
            )
